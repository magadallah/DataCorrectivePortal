...
<!--STYLESHEETS-->
<link rel="stylesheet" href="<c:url value="/resources/css_login/style.css" />">

<!--SCRIPTS-->
<script type="text/javascript" src="<c:url value="/resources/js/jquery.min.login.js"/>"></script>
<!--Slider-in icons-->
...
<form name="login-form" class="login-form" action="login" method="post">
	...
	<!--HEADER-->
    <div class="header">
    <!--TITLE--><h1>${param.pageTitle}</h1><!--END TITLE-->
	<h1>{params.properties}</h1>
    <!--DESCRIPTION--><span>Fill out the form below to login to Data Correction Portal.</span><!--END DESCRIPTION-->
    </div>
    <!--END HEADER-->
