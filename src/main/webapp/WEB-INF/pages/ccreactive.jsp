    ...
    <section class="global-page-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <h2>Credit Card Re-Activate - Deactivate</h2>
                        <ol class="breadcrumb">
                            <li>
                                <a href="home">
                            ...
                            <li class="active">Credit Card Re-Activate - Deactivate</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <section id="about">
        ...
        <h2 class="subtitle wow fadeInUp animated" data-wow-delay=".3s" data-wow-duration="500ms">Now Trending</h2>
            ...
            <div class="block wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="500ms">
                <h1>
                    Credit Card Re-Activation / Deactivation
                    </h1>
                <br>
                <div class="col-sm-3 col-md-6 col-lg-4">
                <p>Please select Credit Card Re-Activation to activate the credit card
                    <br> Or Choose credit card deactivation to deactivate the credit card
...
<img class="img-responsive" src="<c:url value="/resources/images/right.png" />"  height="42" width="42" alt="Chania">
                        ...
                        <div class="col-sm-9 col-md-6 col-lg-8" id= "ValidateCCReAct" style="display:none">
